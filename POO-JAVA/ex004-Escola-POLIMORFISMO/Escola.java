...
public class Escola {
	public static void main(String[] args) {
		...
		Pessoa aluno = new Aluno("Pedro", "(11)923232", "pedro@gmail.com", "31312313");
		Pessoa funcionario = new Funcionario("Xuxu", "(11)323245", "xuxu@gmail.com", "R$2000");
		Pessoa professor = new Professor("Carlos", "(11)9239294", "carlos@gmail.com",
		...
		do {
			...
			case "1":
				...
				switch (opcao) {
				case "1":
					aluno.enviarEmail(); // metodo que manda email para aluno
					break;
				case "2":
					funcionario.enviarEmail();// metodo que manda email funcionario
					break;
				case "3":
					professor.enviarEmail();// metodo que manda email para professor
					break;
				case "0":
